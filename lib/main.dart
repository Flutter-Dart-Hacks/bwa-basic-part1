...
class HomeBasicLatihan extends StatefulWidget {
  const HomeBasicLatihan({Key? key}) : super(key: key);

  @override
  State<HomeBasicLatihan> createState() => _HomeBasicLatihanState();
}

class _HomeBasicLatihanState extends State<HomeBasicLatihan> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
